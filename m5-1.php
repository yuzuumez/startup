...
// DB接続設定
    $dsn = 'mysql:dbname=tb240215db;host=localhost';
    $user = 'tb-240215';
    $password = 'ZbkffR5yyS';
...
if(!empty($_POST["name"])&&!empty($_POST["str"])&&$_POST["pass"]=="password"&&empty($_POST["hidden"]))
{
 ...
 if(!empty($_POST["enum"])&&$_POST["epass"]=="password")
        ...
        <form action=""method="post">
            ...
            value="<?php if(!empty($_POST["enum"])&&$_POST["epass"]=="password"){echo "$ename";}?>"><br>
            
            <input type="text"name="str"placeholder="コメント"
            value="<?php if (!empty($_POST["enum"])&&$_POST["epass"]=="password"){echo "$estr";}?>"><br>
            
            <input type="text"name="pass"placeholder="パスワード"
            value=""><br>
            
             <input type="hidden"name="hidden"
            value="<?php if (!empty($_POST["enum"])&&$_POST["epass"]=="password"){echo ($_POST["enum"]);}?>"><br><!--編集番号を反映する隠しテキストボックス-->
